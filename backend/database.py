...
# Supports environment variable fallback for cloud production databases (e.g. Postgres on Supabase)
SQLALCHEMY_DATABASE_URL = os.getenv("DATABASE_URL", "sqlite:///./netshield_sql.db")
